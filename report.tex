...
\textbf{Scalability:} Performance remains consistent across difficulty levels. Even minimal-clue puzzles (17 givens—theoretical minimum) solve in under 0.02 seconds.
...
\bibitem{glucose} G. Audemard and L. Simon, ``Predicting Learnt Clauses Quality in Modern SAT Solvers,'' in \textit{Proc. IJCAI}, 2009, pp. 399--404.
\end{thebibliography}
